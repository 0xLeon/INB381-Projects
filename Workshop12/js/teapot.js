...
window.onload = function init() {
	...
	gl.bufferData(WebGLRenderingContext.ARRAY_BUFFER, flatten(points), WebGLRenderingContext.STATIC_DRAW);
	
	
	var vPosition = gl.getAttribLocation(program, "vPosition");
	gl.vertexAttribPointer(vPosition, 4, WebGLRenderingContext.FLOAT, false, 0, 0);
	gl.enableVertexAttribArray(vPosition);
	
	
	var nBuffer = gl.createBuffer();
	gl.bindBuffer(WebGLRenderingContext.ARRAY_BUFFER, nBuffer);
	gl.bufferData(WebGLRenderingContext.ARRAY_BUFFER, flatten(normals), WebGLRenderingContext.STATIC_DRAW);
	
	var vNormal = gl.getAttribLocation(program, "vNormal");
	gl.vertexAttribPointer(vNormal, 4, WebGLRenderingContext.FLOAT, false, 0, 0);
...
function render() {
	...
	gl.drawArrays(WebGLRenderingContext.TRIANGLES, 0, index);
