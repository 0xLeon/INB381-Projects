var WebGLGraphicsObject = (function() {
	...
	var __createBuffers = function() {
		...
		this.buffers.normalIndicesBuffer = this.glContext.createBuffer();
	};
	...
	var __bindData = function() {
		...
		this.glContext.bufferData(this.glContext.ARRAY_BUFFER, WebGLHelper.flattenf32(this.meshData.normals), this.glContext.STATIC_DRAW);
		
		this.glContext.bindBuffer(this.glContext.ELEMENT_ARRAY_BUFFER, this.buffers.normalIndicesBuffer);
		this.glContext.bufferData(this.glContext.ELEMENT_ARRAY_BUFFER, WebGLHelper.flattenui16(this.meshData.normalIndices), this.glContext.STATIC_DRAW);
	};
