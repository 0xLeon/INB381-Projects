...
window.onload = function init() {
	...
	var ambientProduct = mult(light.ambientColor, material.ambient);
	var diffuseProduct = mult(light.diffuseColor, material.diffuse);
	var specularProduct = mult(light.specularColor, material.specular);
